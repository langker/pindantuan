...
class AlipaySubmit {
	...
	function buildRequestMysign($para_sort) {
		...
		$mysign = "";
		switch ("MD5"/*strtoupper(trim($this->alipay_config['sign_type']))*/) {
			case "MD5" :
				$mysign = md5Sign($prestr, '1mhjyxxg80m8wpywrscebli2me9xdkwe');
				break;
			default :
				$mysign = "";
		}
	...
	function buildRequestPara($para_temp) {
		...
		$para_sort['sign_type'] = 'MD5';//strtoupper(trim($this->alipay_config['sign_type']));
